...
lr = LogisticRegression(max_iter=5000) # automatically runs a regularized logistic regression; to control the penalty, add argument 'C = value'; C represents the inverse of lambda
model = lr.fit(X_train,y_train) # C is the inverse of lambda
...
y_test_pred_prob1 = y_test_pred_prob[:,1]  # Get the positive class
...
roc_auc_score(y_test, y_test_pred_prob1)